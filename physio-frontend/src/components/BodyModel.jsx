        ...
        <div className="space-y-8">
            ...
            <div className="bg-slate-900 rounded-2xl p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <button onClick={() => handleBodyPartClick(8)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Head
                    </button>

                    <button onClick={() => handleBodyPartClick(2)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Neck
                    </button>

                    <button onClick={() => handleBodyPartClick(3)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Shoulder
                    </button>

                    <button onClick={() => handleBodyPartClick(9)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Upper Arm
                    </button>

                    <button onClick={() => handleBodyPartClick(10)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Elbow
                    </button>

                    <button onClick={() => handleBodyPartClick(11)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Forearm
                    </button>

                    <button onClick={() => handleBodyPartClick(12)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Wrist
                    </button>

                    <button onClick={() => handleBodyPartClick(13)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Hand/Fingers
                    </button>

                    <button onClick={() => handleBodyPartClick(4)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Upper Back
                    </button>

                    <button onClick={() => handleBodyPartClick(5)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Lower Back
                    </button>

                    <button onClick={() => handleBodyPartClick(14)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Chest
                    </button>

                    <button onClick={() => handleBodyPartClick(15)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Abdomen/Core
                    </button>

                    <button onClick={() => handleBodyPartClick(6)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Hip
                    </button>

                    <button onClick={() => handleBodyPartClick(16)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Groin
                    </button>

                    <button onClick={() => handleBodyPartClick(17)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Thigh
                    </button>

                    <button onClick={() => handleBodyPartClick(1)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Knee
                    </button>

                    <button onClick={() => handleBodyPartClick(18)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Shin
                    </button>

                    <button onClick={() => handleBodyPartClick(7)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Ankle
                    </button>

                    <button onClick={() => handleBodyPartClick(19)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Foot
                    </button>

                    <button onClick={() => handleBodyPartClick(20)}
                            className="bg-slate-800 hover:bg-cyan-600 p-4 rounded-xl">
                        Toes
                    </button>
